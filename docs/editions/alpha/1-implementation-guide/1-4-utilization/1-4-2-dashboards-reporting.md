...
<img class="capybara-right" width="250px" src="/en/latest/_images/I.png" alt="Capybara pointing to an infographic dashboard" style="filter: sepia(25%);">Reporting instructions.
...
:alt: 1-4-2-dashboards-reporting
:width: 64px
:class: page-symbol
```
